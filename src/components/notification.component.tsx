...
const Notification: React.FC<NotificationProps> = ({ setIsOpen }) => {
  ...
  return (
    <div className="absolute flex flex-col gap-4 w-4/5 md:w-1/2 h-[98vh] overflow-y-auto top-0 right-0 mt-[1vh] mr-[2vw] md:mr-[0.5vw] bg-bg-secondary p-4 rounded-xs shadow-xs border border-border-color">
