...
const Notification: React.FC<NotificationProps> = ({ setIsOpen }) => {
  ...
  return (
    <div className="absolute flex flex-col gap-4 w-4/5 md:w-1/2 h-[calc(100vh-2rem)] overflow-y-auto top-4 right-4 bg-bg-secondary p-4 rounded-xs shadow-xs border border-border-color">
